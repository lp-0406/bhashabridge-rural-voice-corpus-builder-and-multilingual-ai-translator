...
> Every conversation is also a contribution.  
> Every voice helps shape a fairer AI.

Like **Common Voice**, but for India: **multilingual**, **mobile-first**, **offline-friendly**, and **fun!**
...
| Layer       | Tech                                             |
|-------------|--------------------------------------------------|
| Frontend    | Streamlit + PWA wrapper **OR** Flutter Web (TBD) |
| Backend     | Python + SQLite **OR** Firebase for syncing      |
| Models      | Whisper (STT), Coqui STT, IndicTrans2, OpenTTS   |
| Data Store  | Local → Synced to **Hugging Face Datasets**      |
...
| Week | Focus                                                                 |
|------|-----------------------------------------------------------------------|
| 1️⃣   | Build working prototype — test with ourselves                        |
| 2️⃣   | Demo in a local school — test with 10 children                       |
| 3️⃣   | Launch "**Voice for Bharat**" drive — collect 1,000 utterances       |
| 4️⃣   | Publish dataset on Hugging Face + release demo video & docs         |
...
- Enable crowd-powered language preservation efforts  
